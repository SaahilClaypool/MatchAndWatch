...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20201118194353_Invite")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Models.Session", b =>
                {
                    b.HasOne("Infrastructure.Models.ApplicationUser", "Creater")
                        .WithMany()
                        .HasForeignKey("CreaterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("Core.Models.InviteLink", "Invite", b1 =>
                        {
                    ...
                    b.OwnsMany("Core.Models.ParticipantStatus", "Participants", b1 =>
                        {
                            b1.Property<string>("SessionId")
                                .HasColumnType("TEXT");
                            ...
                            b1.ToTable("ParticipantStatus");

                            b1.WithOwner()
                                .HasForeignKey("SessionId");

                            b1.HasOne("Infrastructure.Models.ApplicationUser", "User")
                                .WithMany()
                                .HasForeignKey("UserId")
                                .OnDelete(DeleteBehavior.Cascade)
                                .IsRequired();
